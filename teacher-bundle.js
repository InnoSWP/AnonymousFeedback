...
var require$$5 = /*@__PURE__*/getAugmentedNamespace(componentEmitter);
...
function installTimerFunctions(obj, opts) {
    if (opts.useNativeTimers) {
        ...
        obj.setTimeoutFn = setTimeout.bind(globalThis_js_1$3.globalThisShim);
        obj.clearTimeoutFn = clearTimeout.bind(globalThis_js_1$3.globalThisShim);
    }
}
...
const debug_1$6 = __importDefault$6(browser$1.exports); // debug()
const debug$6 = (0, debug_1$6.default)("engine.io-client:transport"); // debug()
...
xmlhttprequest_browser.XHR = void 0;
...
const debug_1$5 = __importDefault$5(browser$1.exports); // debug()
const yeast_js_1$1 = yeast$1;
const parseqs_js_1$2 = parseqs;
...
const debug$5 = (0, debug_1$5.default)("engine.io-client:polling"); // debug()
function empty() { }
...
class Polling extends transport_js_1$1.Transport {
    ...
    uri() {
        ...
        if (false !== this.opts.timestampRequests) {
            query[this.opts.timestampParam] = (0, yeast_js_1$1.yeast)();
        }
        ...
        const encodedQuery = (0, parseqs_js_1$2.encode)(query);
...
const debug_1$4 = __importDefault$4(browser$1.exports); // debug()
const engine_io_parser_1$1 = cjs$1;
const debug$4 = (0, debug_1$4.default)("engine.io-client:websocket"); // debug()
...
const debug_1$3 = __importDefault$3(browser$1.exports); // debug()
...
const debug_1$2 = __importDefault$2(browser.exports); // debug()
const debug$2 = debug_1$2.default("socket.io-client:url"); // debug()
/**
 * URL parser.
 *
 * @param uri - url
...
function requireCjs () {
	...
	(function (exports) {
		...
		const is_binary_js_1 = requireIsBinary();
		const debug_1 = browser.exports; // debug()
...
const debug_1$1 = __importDefault$1(browser.exports); // debug()
const debug$1 = debug_1$1.default("socket.io-client:socket"); // debug()
/**
 * Internal events.
...
const component_emitter_1 = require$$5;
const debug_1 = __importDefault(browser.exports); // debug()
...
(function (module, exports) {
	 ...
	 * @public
	 */
	var socket_io_parser_1 = requireCjs();
...
export { teacherClient as default };
